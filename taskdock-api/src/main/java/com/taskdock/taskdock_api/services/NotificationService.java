...
public interface NotificationService {
  ...
  /**
   * Sends an email verification notification to a newly registered user.
   *
  ...
  /**
   * Sends a welcome notification after the user has successfully verified their email.
   *
  ...
  /**
   * Sends a notification informing a user that they have been added to a board.
   *
   ...
   */
  void sendBoardInvitation(User invitedUser, User invitedBy, Board board);

  /**
   * Sends a notification informing a user that a task has been assigned to them.
   *
